...
public enum GladiatorSelfObservationIndex
{
    ...
    ExternalSmoothedLocalMoveX = 17,
    ExternalSmoothedLocalMoveZ = 18,
    ExternalSmoothedTurn = 19,
    ExternalPreviousRawLocalMoveX = 20,
    ExternalPreviousRawLocalMoveZ = 21,
    ExternalPreviousRawTurn = 22,
    HasReadySkill = 23,
    HasTarget = 24,
}
