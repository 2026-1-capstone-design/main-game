...
```bash
mlagents-learn Assets/Configs/ML-Agents/Stage_1_smooth.yaml --run-id=gladiator_smooth_001
```
...
1. `TrainingScene`의 agent `BehaviorParameters`가 trainer YAML의 behavior name과 일치하는지 확인합니다.
   ...
   - action contract는 continuous 3개, discrete branch `[3, 6, 3]`, observation size `101`입니다.
