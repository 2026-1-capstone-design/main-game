...
public sealed class BuiltInAiControlSource : IBattleUnitControlSource
{
    ...
    public void Configure(IReadOnlyList<BattleRuntimeUnit> units, BattleAITuningSO aiTuning)
    {
        _units = units;
        _aiTuning = aiTuning;
    }
    ...
    )
    {
        ...
        _decisionSystem.DecideBuiltInUnit(_units, unit, _aiTuning, tickDeltaTime);
