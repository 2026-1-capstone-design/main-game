...
public interface IBattleArtifact
{
    ...
    void Initialize(BattleRuntimeUnit owner, in BattleEffectContext context);
}
...
{
    void OnBattleStart(BattleRuntimeUnit owner, in BattleEffectContext context, IBattleEffectSink effects);
}
...
{
    void ModifyDamage(BattleRuntimeUnit owner, ref BattleDamageRequest request);
}
