...
```bash
pnpm install -g ctx7@latest # First, try pnpm
npm install -g ctx7@latest # If you don't have pnpm
```

Or run directly without installing:

```bash
pnpx ctx7@latest <command> # First, try pnpx with pnpm
npx ctx7@latest <command> # If you don't have pnpm
```
